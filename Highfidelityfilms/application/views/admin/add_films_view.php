            ...
            <div class="container" style="width: auto;">
                ...
                <ul class="nav pull-right">
                    <ul class="nav">
                        ...
                        <form method="POST" onclick="return false;" class="navbar-search pull-right" action="" ><i class="icon-search"></i>
                            <input  type="text" id='search_film' class="search-query span3" placeholder="Enter film title" style="height: auto;">
                            <input value="Search" type="submit" id="searchid">
                        </form>
                </ul>
...
<div class="container" style="padding-bottom: 10px">
    <div class="row">
        ...
        <div class="span9">
            ...
            <?php if(isset($errmsg)): ?><div class="alert alert-error">
    ...
    <script>
         ...
         $('#searchid').click(function() {
             //var query =  document.getElementById('search_film').value;
            var query =  $('#search_film').val();
            //alert(window.query);
        ...
        function searchCallback(data) {
            ...
            $.each(movies, function(index, movie) {
                ...
                mydata += "<tr><td>"+movie.title +'</td> <td>'+'<img src="' +  movie.posters.thumbnail+'" /> </td> <td>'
                        +'<a href="http://highfidelityfilms.co.uk/index.php/add_films/test?film_id='+movie.id+'"><button type="button" class="btn btn-success">Add me</button></a>'
                        +'</td></tr>' ;
